...
import TelaLancamentoFinancas from "../views/TelaLancamentoFinancas";
import TelaPainelAnalitico from "../views/TelaPainelAnalitico";
...
export type RootStackParamList = {
  ...
  TelaPainelAnalitico: undefined;
  TelaLancamentoHoras: { projetoId: string; projetoNome: string };
  TelaLancamentoFinancas: undefined;
  ...
  if (perfil?.nivel_acesso === "gestor") {
    return (
      ...
      >
        ...
        <Stack.Screen
          name="TelaPainelAnalitico"
          component={TelaPainelAnalitico}
          options={{
            headerShown: false,
          }}
        />
